...
*
* Example:
* ["ambush1", true, "all"] call cvo_common_fnc_toggleLayerAI; // enable units of the layer
* ["ambush1", false, "all"] call cvo_common_fnc_toggleLayerAI; // disables units of the layer
* ["ambush1", false, ["path", "fireweapon"]] call cvo_common_fnc_toggleLayerAI; // disables pathing and firingweapon
*
* Public: yes
*/
