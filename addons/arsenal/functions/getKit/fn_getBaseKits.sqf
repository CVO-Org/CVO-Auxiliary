...
_configs append ( Q(configName _x isNotEqualTo QQ(Base)) configClasses (configFile >> QADDON >> Q(kits_base)) select { missionNamespace getVariable [ [QADDON, "kit", "base", configName _x] joinString "_", false ]; } ) ;
...
_configs append ( Q(configName _x isNotEqualTo QQ(Base)) configClasses (missionConfigFile >> QADDON >> Q(kits_base)) select { missionNamespace getVariable [ [QADDON, "kit", "base","mission" configName _x] joinString "_", false ]; } ) ;
