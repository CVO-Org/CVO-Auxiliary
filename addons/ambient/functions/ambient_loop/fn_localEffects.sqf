...
diag_log format ['[CVO](debug)(fn_localEffects) _helper: %1 - _sound: %2 - _distance: %3', _helper , _sound ,_distance];

private _soundsource = _helper say3D [ _sound, _distance * 2.5, 1 + random 0.5 ];

diag_log format ['[CVO](debug)(fn_localEffects) _soundSource: %1', _soundSource];
